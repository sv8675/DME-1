...
public class TestJMSAuthenticationServer {
	...
	public TestJMSAuthenticationServer() throws Exception {
	...
	public void init() throws Exception {
		...
		requestQueue = (Queue) context.lookup(TestConstants.authServiceToRegister);
		...
		System.out.println("TestJMSServer.init(): requestQueue.getListeners().size()="
	...
	public static void main(String[] args) throws Exception {
		TestJMSAuthenticationServer server = new TestJMSAuthenticationServer();
