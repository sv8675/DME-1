...
public class TestEmptyReplyListener implements MessageListener {
	private QueueConnection connection = null;
	private Queue dest = null;
	private QueueReceiver receiver = null;
	private QueueSession session = null;
	
	public TestEmptyReplyListener(QueueConnection connection,
	...
	public void onMessage(Message msg)
    {
	    try
        {
	        System.out.println("TestEmptyReplyListener thread=" + Thread.currentThread().getId() + " received request");
	        Queue replyTo = (Queue)msg.getJMSReplyTo();
	        System.out.println("TestEmptyReplyListener thread=" + Thread.currentThread().getId() + " will respond to " + replyTo.getQueueName());
	        ...
	        if(replyTo != null)
	        {
	        	...
	        	//replyMsg.setText("TestEmptyReplyListener:::" + ((TextMessage)msg).getText());
	        	...
	        	producer.close();
	        	System.out.println("TestEmptyReplyListener thread=" + Thread.currentThread().getId() + " responded to " + replyTo.getQueueName());
	        }
	        else
	        {
