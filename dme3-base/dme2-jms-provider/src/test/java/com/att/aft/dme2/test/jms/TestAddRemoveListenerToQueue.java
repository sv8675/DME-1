...
public class TestAddRemoveListenerToQueue extends JMSBaseTestCase {
	...
	@Test
	public void testAddRemoveListenerToQueue() throws Exception {
		...
		LocalQueueMessageListener listener = new LocalQueueMessageListener(connection, session, requestQueue);
		// add Listener
