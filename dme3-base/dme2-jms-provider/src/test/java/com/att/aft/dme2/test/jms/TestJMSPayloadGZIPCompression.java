...
public class TestJMSPayloadGZIPCompression extends JMSBaseTestCase {
	...
	@Test
	public void testDME2JMSPayloadCompression() throws Exception {
		String serverStr = "http://DME2LOCAL/service=com.att.aft.dme2.test.TestJMSPayloadCompression/version=1.0.0/envContext=LAB/routeOffer=PRIMARY";
		String clientStr = "http://DME2RESOLVE/service=com.att.aft.dme2.test.TestJMSPayloadCompression/version=1.0.0/envContext=LAB/routeOffer=PRIMARY";
		...
		try {
			...
			table.put("AFT_DME2_MANAGER_NAME", "testDME2JMSPayloadCompression");
			...
			msg.setStringProperty("accept-encoding", "gzip");
			msg.setText(
			...
			assertTrue(resp.getStringProperty("Content-Encoding") != null);
			assertTrue(resp.getStringProperty("Content-Encoding").contains("gzip"));
