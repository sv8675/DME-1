...
public class TestMetricsMessageListener implements javax.jms.MessageListener
{
	...
	public TestMetricsMessageListener(QueueConnection connection, QueueSession session, Queue dest)
	{
    ...
    public void onMessage(Message msg)
    {
	    try
        {
	        ...
	        if(replyTo != null)
	        {
	        	...
	        	replyMsg.setText("TestMetricsMessageListener:::" + ((TextMessage)msg).getText());
	        	...
	        	producer.close();
	        	System.out.println("TestMetricsMessageListener thread=" + Thread.currentThread().getId() + " responded to " + replyTo.getQueueName());
	        }
	        else
	        {
