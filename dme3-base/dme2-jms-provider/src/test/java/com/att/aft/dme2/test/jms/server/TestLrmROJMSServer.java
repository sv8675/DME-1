...
public class TestLrmROJMSServer {
	...
	public TestLrmROJMSServer() throws Exception {
	}
	...
	public void init() throws Exception {
		if (city.equals("BHAM"))
			...
			Locations.JACK.set();
		System.setProperty("lrmRO", "BAU_SE_1");
		...
		System.out.println("TestLrmROJMSServer.init(): requestQueue.getListeners().size()="
				+ ((DME2JMSLocalQueue) requestQueue).getListeners().size());

		System.out.println("TestLrmROJMSServer started successfully...");
		...
		f.delete();
		System.setProperty("lrmRO", null);
		System.out.println("TestLrmROJMSServer destroyed.");
	}

	public static void main(String[] args) throws Exception {
		TestLrmROJMSServer server = new TestLrmROJMSServer();
