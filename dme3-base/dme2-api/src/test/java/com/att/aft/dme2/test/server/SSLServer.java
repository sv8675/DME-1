...
public class SSLServer{
		...
		public void init() throws Exception
		{
	        ...
	        String uriStr = "/service=com.att.aft.TestSSLEndpointsRenegotiate2/version=1.0.0/envContext=DEV/routeOffer=BAU";
			...
			props1.setProperty("AFT_DME2_PORT", "46789");
			...
			DME2Manager serverManager = new DME2Manager("testSSLEnabled", config, props1);
			serverManager.bindServiceListener(uriStr,  new EchoServlet(
					"service=com.att.aft.TestSSLEndpointsRenegotiate2/version=1.0.0/envContext=DEV/routeOffer=BAU",
					"1"));
			serverManager.start();
