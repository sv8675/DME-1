...
public class JMXUtil 
{
    ...
    logger.debug( null, null, "registerMXAsStandardMBean", LogMessage.JMX_REGISTER, name, mxBean );
      ...
      logger.error( null, null, "registerMXAsStandardMBean","AFT-DME2-1900", new ErrorContext().add("DME2MBean", name), e);
		}	
	}
	...
	public <T> void registerMXBean(String name, T mxBean)
	{
		...
		catch(Exception e) 
		{
			...
			// otherwise log errors
      logger.error( null, null, "registerMXBean", "AFT-DME2-1900", new ErrorContext().add("DME2MBean", name), e);
		}	
	}
}
